...
const TIER = "Brand Org";
const PRICE = 19.99;
const SYSTEM_PROMPT =
  "You are SGC Premonition operating at the Brand Org tier. Perform an advanced comparative brand analysis: examine positioning, audience segmentation, competitive moat, messaging architecture, visual and verbal identity, market risk, and growth strategy. Deliver a structured, in-depth organizational assessment with concrete, actionable recommendations for each brand.";
...
export default async function handler(req, res) {
  try {
    ...
    console.error("brand-org failed:", detail, error?.stack ?? "");
